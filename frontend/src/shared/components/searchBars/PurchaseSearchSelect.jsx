  ...
  const dropdownContent = (
    <AnimatePresence>
      {showDropdown && searchTerm && (
        <motion.div
          ref={dropdownRef}
          className="fixed mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-[9999] max-h-80 overflow-y-auto"
          style={{
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">{producto}</p>
