...
const helpVideos = [
  {
    id: "1",
    title: "Tutorial completo del módulo de clientes",
    youtubeId: "2baqU9m6_qs",
  }
];

export default function HelpSidebarClientes() {
        ...
        {selectedVideo && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <motion.div className="relative bg-black rounded-xl w-full max-w-5xl aspect-video z-10">
              ...
              <button
                onClick={() => setSelectedVideo(null)}
                className="absolute top-4 right-4 bg-white hover:bg-gray-200 text-black rounded-full p-2 shadow-lg transition z-20"
              >
                <FiX size={20} />
              </button>
