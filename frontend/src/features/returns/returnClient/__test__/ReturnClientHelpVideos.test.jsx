...
import ReturnClientHelpVideos from "../ReturnClientHelpVideos.jsx";

describe("ReturnClientHelpVideos", () => {
  test("debe abrir el panel y mostrar los videos de ayuda", () => {
    render(<ReturnClientHelpVideos />);
    ...
    expect(screen.getByText("Anular devolución de cliente")).toBeInTheDocument();
