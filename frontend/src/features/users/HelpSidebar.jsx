...
const helpVideos = [
  {
    id: "1",
    title: "Como registrar un usuario",
    youtubeId: "ppEB-VFafAk", // Reemplazar con ID real
  },
  {
    id: "2",
    title: "Como editar un usuario",
    youtubeId: "2YxdJFHcQSc", // Reemplazar con ID real
  },
  {
    id: "3",
    title: "Ver detalles de un usuario",
    youtubeId: "tlqmiIabuR4", // Reemplazar con ID real
  },
  {
    id: "4",
    title: "Como eliminar un usuario",
    youtubeId: "RuE38RH_V4I", // Reemplazar con ID real
  }
];
            ...
            >
              <div className="p-4 border-b flex justify-between items-center bg-gray-50">
                <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                  <FiHelpCircle className="text-green-600" /> Ayuda en línea
                </h2>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                <p className="text-sm text-gray-600 mb-4">
                  Selecciona uno de nuestros videos tutoriales para aprender más sobre cómo usar esta sección.
                </p>
