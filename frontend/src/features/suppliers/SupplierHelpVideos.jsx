...
const SUPPLIER_HELP_VIDEOS = [
  {
    title: "Editar proveedor",
    embedUrl: "https://www.youtube.com/embed/rkC7bYFFyws",
    watchUrl: "https://youtu.be/rkC7bYFFyws",
  },
  {
    title: "Eliminar proveedor",
    embedUrl: "https://www.youtube.com/embed/gl3q0E33V6w",
    watchUrl: "https://youtu.be/gl3q0E33V6w",
  },
  {
    title: "Registrar proveedor",
    embedUrl: "https://www.youtube.com/embed/wnIPknhKRX0",
    watchUrl: "https://youtu.be/wnIPknhKRX0",
  },
  {
    title: "Ver detalle proveedor",
    embedUrl: "https://www.youtube.com/embed/XHCatRta5ug",
    watchUrl: "https://youtu.be/XHCatRta5ug",
  },
];
...
export default function SupplierHelpVideos() {
    ...
    <div className="pointer-events-none fixed inset-0 z-40">
      ...
      >
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-5">
          {SUPPLIER_HELP_VIDEOS.map((video) => (
      ...
      <div className="pointer-events-auto absolute bottom-4 right-4 sm:bottom-5 sm:right-5">
        <button
          ...
          aria-controls="supplier-help-videos"
