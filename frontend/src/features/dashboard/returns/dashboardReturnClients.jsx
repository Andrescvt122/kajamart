...
export default function DashboardReturnClients() {
  ...
  const totalReturns = useMemo(
    () => monthlyVolume.reduce((a, b) => a + b, 0),
    [monthlyVolume]
  );
  ...
  const reasons = useMemo(
    () => ({
      labels: ["Artículo Incorrecto", "Dañado", "No Necesitado", "Vencido"],
      values: [22, 15, 20, 12],
    }),
    []
  );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900">
            Panel de control devolucion a clientes
          </h1>
          <p className="text-sm text-emerald-700 mt-2">
            Analice y gestione las devoluciones de clientes.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          ...
          <div className="rounded-lg border border-green-100 p-6 bg-white shadow-sm">
            <p className="text-sm text-gray-600">
              Valor Promedio de Devolución
            </p>
            <div className="mt-3 flex items-baseline gap-4">
              <span className="text-3xl font-bold text-gray-900">
                ${avgReturnValue.toFixed(2)}
              </span>
            </div>
          ...
          <div className="rounded-lg border border-green-100 p-6 bg-white shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
              <div className="md:col-span-2">
                <p className="text-sm text-gray-600">
                  Volumen Mensual de Devoluciones
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="rounded-lg border border-green-100 p-6 bg-white shadow-sm">
            <p className="text-sm text-gray-600">
              Distribución de Razones de Devolución
            </p>
            <h3 className="text-xl font-semibold mt-2">5</h3>
            <p className="text-sm text-emerald-700 mt-1 mb-4">
              Últimos 3 Meses
